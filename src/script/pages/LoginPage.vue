        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form @submit.prevent="handleLogin">
              ...
              <!-- Password input -->
              <div class="form-outline mb-2">
                <input v-model="password" :type="passwordFieldType" class="form-control form-control-lg"
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <router-link :to="{ name: 'RegisterPage' }" href="#!"
      ...
      async handleLogin() {
        try {
          ...
          if (error.response) {
            ...
            this.message = error.response.data.messages.message;
